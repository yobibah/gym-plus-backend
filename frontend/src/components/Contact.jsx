...
import { Mail, Pencil, Loader2, Smile } from "lucide-react";
...
export default function Contact(){
    ...
    return(
        <div className="xl:py-12 relative 2xl:py-10 xl:mt-30 md:mt-30 lg:mt-30 md:py-15 lg:py-10  px-4 py-15" id="contact">
                        ...
                        <form onSubmit={Submit} className="w-full max-w-md bg-white shadow-lg rounded-xl p-6 md:p-8 flex flex-col gap-4 md:gap-6">
                            ...
                            <div className="relative">
                                ...
                                <Input 
                                    ...
                                    className={"block w-full pl-10 pr-3 py-3 rounded-xl bg-orange-100 border border-orange-200 focus:outline-none transition-all text-sm md:text-base"}
                                />
                            </div>
                            ...
                            <div className="relative">
                                ...
                                <textarea 
                                    ...
                                    rows="6"
                                    className="w-full block bg-orange-100 pl-10 pr-3 py-3 rounded-xl focus:outline-none transition-all resize-none text-sm md:text-base"
                                />
                            </div>
            ...
            <motion.div 
                ...
                className="absolute shadow-lg flex flex-col gap-2 -bottom-50 right-5 p-4 w-100 bg-orange-100">
                <p className="text-xl text-green-500 font-bold">Envoie réussi !</p>
                ...
                <div className="flex items-center gap-1">
                    <p> Merci!</p>
                    <Smile className=" h-5 w-5" fill="yellow" stroke="gray"/>
                </div>
            </motion.div>
            )}
            ...
            <motion.div 
                ...
                transition={{duration: 0.4}}
                className="absolute shadow-lg flex flex-col gap-2 -bottom-50 right-5 p-4 w-100 bg-orange-100">
                <p className="text-xl text-red-500 font-bold">Erreur survenue !</p>
                <p className="text-gray-700 ">
                    Une erreur est survenue, vérifier vos informations
                    et réesssayez à nouveau.
                </p>
            </motion.div>
            )}
        </div>
