                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="text-align:center; padding-bottom:20px;">
                            <h1 style="margin:0; font-size:24px; color:#ff7a00;">
                                Facture Abonnement / Réabonnement 
                            </h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="color:#333333; font-size:16px; line-height:1.7;">
                            ...
                            <p>
                                Bonjour <strong>{{ $Adherant->prenom }} {{ $Adherant ->name }}</strong> 👋
                            </p>
                            ...
                            <div style="background-color:#fff7ed; border-left:5px solid #ff7a00;
                                ...
                                <strong style="color:#ff7a00;">✅ Réabonnement /abonnement effectué avec succès</strong><br>
                            ...
                            <p>
                                ...
                                <strong style="color:#ff7a00;">{{ $salle->contact }}</strong>
                            </p>
